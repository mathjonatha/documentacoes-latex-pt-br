\section{Estilos predefinidos}\label{custom}
...
\begin{NewMacroBox}{tkzSetUpPoint}{\oarg{local opções}}%
\begin{tabular}{lll}%
...
\subsubsection{Simple exemplo with \tkzcname{tkzSetUpPoint}}
...
\begin{NewMacroBox}{tkzSetUpLine}{\oarg{local opções}}%
\begin{tabular}{lll}%
opções &  padrão & definição                 \\
\midrule
...
\subsubsection{Exemplo 3: extend lines}
\begin{tkzexample}[latex=7cm,small]
  \begin{tikzpicture}[scale=.75]
...
\begin{NewMacroBox}{tkzSetUpArc}{\oarg{local opções}}%
\begin{tabular}{lll}%
opções &  padrão & definição                 \\
\midrule
...
\begin{NewMacroBox}{tkzSetUpCompass}{\oarg{local opções}}%
\begin{tabular}{lll}%
opções &  padrão & definição                 \\
\midrule
\TOline{color}{black}{colour of the construction lines}
...
\begin{NewMacroBox}{tkzSetUpStyle}{\oarg{local opções}}%
  The opções are the same as those of \TIKZ
\end{NewMacroBox}
...
Here are some exemplos of how to place these arrows.
\tkzname{ tkz-euclide} loads a library called \tkzname{arrows.meta}.
 
|\usetikzlibrary{arrows.meta}|

This  library is used to produce different styles of arrow heads. The next exemplos use some of them. 
...
\medskip
 ...
 \begin{itemize}
\item |tkz arrow| (\tkzname{Latex} by padrão)
\item |tkz arrow=<arrow end tip>|
\item |tkz arrow=<arrow end tip> at <pos> (<pos> = .5 by padrão)|
\item |tkz arrow={<arrow end tip>[<arrow opções>] at <pos>}| opção possible \tkzname{scale}
 \end{itemize}
